...
class Bot(Client):
    ...
    async def start(self):
        ...
        try:
            ...
            self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/spideyofficial777 for support")
            sys.exit()
        ...
        self.LOGGER(__name__).info(f"Bot Running..! Made by @Spideyofficialupdatez")   
    ...
    def run(self):
        ...
        self.LOGGER(__name__).info("Bot is now running. Thanks to @spideyofficial777")
        try:
            loop.run_forever()
